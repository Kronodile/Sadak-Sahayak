...
if __name__ == '__main__':
    # test how it works
    fcw = ForwardCollisionWarning('models/road-segmentation/trained_model_33_cpu.h5')
    img_path = 'C:/IOMP/vision-based-adas-main/vision-based-adas-main/assets/FCW-images/07-input-img.jpg'
